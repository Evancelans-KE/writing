#include <iostream>   // Accepting varius inputs ands outputs
#include <fstream>    // Accepts input as a file
#include <cassert>    // Used when we want to get the assert statement
#include <cctype>     // When we want to get the tlower() function
#include <vector>     // To capture varous functions in code
#include <ctime>      // To addd timer based functionalities
using namespace std;
//--------------------------------------------------------------------------------
// use this function to dispaly name and program information
void displayIdentifyingInformation()
{
   cout << "  \n"
        << "Welcome to the program: Typing tutor  \n"
        << "Computer Sceince 2021:     \n"
        << endl;
}//Close function

//--------------------------------------------------------------------------------
// We engage the vector to get the dictionary values
// retrun index if matched otherwise -1
long binarySearch( string searchWord,            // The word in search parameters
